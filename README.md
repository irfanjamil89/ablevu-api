...
```
## DB Migrations
Create migration in src/migration folder. and run following commands to generate and execute migration.
...
```bash
POSTGRES_HOST=51.75.68.69
POSTGRES_PORT=5432
POSTGRES_USER=postgres
POSTGRES_PASSWORD=irfan
POSTGRES_DATABASE=ablevu
PORT=3006
MODE=DEV
